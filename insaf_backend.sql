...
--
-- Host: localhost:3306
-- Generation Time: May 01, 2026 at 11:41 PM
...
--
-- Database: `ibravphe_insaf_backend`
--
...
CREATE TABLE `applications` (
  ...
  `course_intake_id` bigint(20) UNSIGNED NOT NULL,
...
(11, 'APP-2026-00001', 7, 3, 4, 4, NULL, 'pending', 'pending', 'normal', NULL, NULL, 'pending', 0, 0, 0, 0, 0, NULL, 0.00, 'need_revision', 1, '2026-04-20', 1, '2026-04-20', 1, '2026-04-20', 'not_applied', NULL, NULL, NULL, 3, '2026-04-15 02:17:11', '2026-04-20 01:18:23');
...
('admin-dashboard-cache-tyro:user-1:roles', 'a:1:{i:0;s:5:\"admin\";}', 1777350868),
...
('admin-dashboard-cache-tyro:user-4:privileges', 'a:4:{i:0;s:11:\"*accountant\";i:1;s:8:\"*payment\";i:2;s:10:\"*comission\";i:3;s:8:\"*invoice\";}', 1777552883),
('admin-dashboard-cache-tyro:user-4:roles', 'a:1:{i:0;s:10:\"accountant\";}', 1777552883),
('admin-dashboard-cache-tyro:user-6:privileges', 'a:1:{i:0;s:12:\"*application\";}', 1777293091),
('admin-dashboard-cache-tyro:user-6:roles', 'a:1:{i:0;s:11:\"application\";}', 1777293091),
('admin-dashboard-cache-tyro:user-7:privileges', 'a:1:{i:0;s:18:\"*digital_marketing\";}', 1777204629),
('admin-dashboard-cache-tyro:user-7:roles', 'a:1:{i:0;s:17:\"digital-marketing\";}', 1777204628);
...
INSERT INTO `commissions` (`id`, `application_id`, `user_id`, `percentage`, `amount`, `proposed_amount`, `status`, `workflow_status`, `claimed_at`, `claim_notes`, `reviewed_by`, `reviewed_at`, `review_notes`, `notes`, `created_at`, `updated_at`) VALUES
(1, 11, 3, NULL, 0.00, 3000.00, 'pending', 'claimed', '2026-04-25 01:09:23', NULL, NULL, NULL, NULL, NULL, '2026-04-25 01:09:23', '2026-04-25 01:09:23');
...
(4, 7, 11, 3, 'INV-20260420-5CF7', '2026-04-20', '2026-04-27', 7000.00, 'draft', 'security deposit fee', '2026-04-19 22:50:21', '2026-04-19 23:46:07');
...
(9, 4, 6, 'security fee from student', 1.00, 5000.00, 5000.00, 0.00, 5000.00, '2026-04-19 23:46:07', '2026-04-19 23:46:07'),
(10, 4, 6, 'fee from student', 1.00, 2000.00, 2000.00, 0.00, 2000.00, '2026-04-19 23:46:07', '2026-04-19 23:46:07');
...
--
-- Dumping data for table `marketing_documents`
--
...
CREATE TABLE `marketing_posters` (
  ...
  `status` enum('ready','not_ready','uploaded') NOT NULL DEFAULT 'not_ready',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `marketing_videos` (
  ...
  `status` enum('edited','upload','not_edited','ready') NOT NULL DEFAULT 'not_edited',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('1Io1kpIDtFmr6vRKJRhFSAVq05czwtmgUssFaYXx', NULL, '185.247.137.253', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777415272),
('1VHgSI1nsJzpAE6nqcGsoEjafd7OvhQlbNjklj9N', NULL, '107.173.171.201', 'Mozilla/5.0 (CentOS; Linux i686; rv:122.0) Gecko/20100101 Firefox/122.0', '', 1777443112),
('2DpHbQXsJC1rS311MoElf4nlBMwPB9eYRiyQAs0Q', NULL, '192.3.169.184', 'Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; GPTBot/1.3; +https://openai.com/gptbot)', '', 1777458035),
('3zyg2Z4eINnuoXQpyuWZUuFGVnFRZp5yIDlUZlSK', NULL, '2602:80d:1007::63', 'Mozilla/5.0 (compatible; CensysInspect/1.1; +https://about.censys.io/)', '', 1777641835),
('8HUznVMu3qIL1dxkW4XPva7v1h8MNUTpakPCOG0N', NULL, '44.216.112.0', 'Mozilla/5.0 AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/605.1.15', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiQ1hiUVl3bmczd3AyaVNkWGdMRGNka0RHUVJ0T3UzQkM2QUN3V0FRQyI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1777610977),
('Cn8Zww1J9j6aZDYVQWaYkvzelzymOtFWy5taDdQf', NULL, '185.247.137.65', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777427914),
('Cnb88HW9hq8KAlSny3C37821sXARspm99woaALGm', NULL, '35.171.57.19', 'Mozilla/5.0 AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/605.1.15', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoidmVIV0loWlAyS0k2WHJNMTFVM08yUFowR3R0ZXNVVFNiMTVnbU50YyI7czoxMDoidHlyby1sb2dpbiI7YToxOntzOjc6ImNhcHRjaGEiO2E6MTp7czo1OiJsb2dpbiI7aToxMjt9fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1777496312),
('dcaG9sOeNauZBokafWIkzuYmEBEZYGfxMHxTzTSy', NULL, '103.88.140.181', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36', '', 1777535460),
('dglwBx24X6yGKdXwj0MUXUv2XUB9rEX3kdPxXAqB', NULL, '103.88.140.181', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36', '', 1777553208),
('iWWrtXMorThd8miDKdi7VKrXCMcU1FLF8eeWWesq', NULL, '2602:80d:1007::63', 'Mozilla/5.0 (compatible; CensysInspect/1.1; +https://about.censys.io/)', '', 1777641835),
('JNE281NJzRq7PHKEBIdq5mmdicvVV2093ay1GQz1', 4, '103.88.140.181', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36', '', 1777552802),
('kZjzZ0IvWgcFGnkwkJmcx5uiJgNqGCAzP4bNaxOv', NULL, '87.236.176.165', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777399625),
('MsrEdczBPNv5nMjR2Z2cQkyJB1tFMYEGFINWMnah', NULL, '87.236.176.193', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777411767),
('n5FzrRKcZy4FLFSvjZHNfvmqdoVNYNqm4mZ465nB', NULL, '162.220.232.230', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36', '', 1777411426),
('plTt4cCdRxtfRRplr2dQR3GAQ0dasU77cUvcUvDI', NULL, '162.220.232.230', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36', '', 1777411423),
('qt3WYh1gfu8WGq4W8owuXB8mfpC6Y4yZG665nzRs', 4, '103.88.140.180', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36', '', 1777522529),
('R4007bJUSvc8NO4vkXCVytOmTyXLhqXz4Vhc7YkA', NULL, '23.21.169.164', 'Mozilla/5.0 AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/605.1.15', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoibVlBWUJzU3hneUNmQXprTUlZWkhya1Y2U1NBVzJIa0l1MmM5SGZiaSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1777626827),
('ReyLOkCjWKHWXBSZnBxwDK0fpaxFqFoqduTLINqF', NULL, '162.220.232.230', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36', '', 1777411426),
('RuorkVUEtR9hYDTykyyv2Iw5hVv0stBJCZiWOX7v', NULL, '192.3.169.184', 'Mozilla/5.0 (compatible; SemrushBot/7~bl; +http://www.semrush.com/bot.html)', '', 1777458027),
('S2vTW4bfPO9xIzXwTDhXjGRsk88TPhrPlnYampLH', NULL, '185.247.137.253', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777415271),
('S9Rw3HQOyVZcTMVQBmTB062GW5MCgC0jEnXs0BdA', NULL, '195.178.110.48', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/122.0.0.0 Safari/537.36', '', 1777652808),
('vXhjxaRxHsSlHWNl3Yfk8iNOaXGCgApJb2XbCYVW', NULL, '192.3.169.184', 'Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; GPTBot/1.3; +https://openai.com/gptbot)', '', 1777458035),
('WYdqezG0bFkjzhBTHoVzySTto2WkjCZvvUTbyGrq', NULL, '103.88.140.181', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36', '', 1777518681),
('X7ffJfyv7yIKtHAXK3MckSZ0Pwv1dOVcwd4logxM', NULL, '162.220.232.230', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36', '', 1777411425),
('XS8ouaS5PRpNDXbFNEpJtTY9I4LF38evDIztADcT', NULL, '3.221.20.132', 'Mozilla/5.0 AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/605.1.15', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoic0VVOHF0bmZwTm16akZteGRkaXBzRWJBSTJ4aERTb0piRnNiaFJyUSI7czoxMDoidHlyby1sb2dpbiI7YToxOntzOjc6ImNhcHRjaGEiO2E6MTp7czo4OiJyZWdpc3RlciI7aToyO319czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1777488949),
('ZhATnfPN4UU68f6H0kXRTeJDw2ySC4cPO74jQMY9', NULL, '87.236.176.165', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777399625),
('ZOcvG31zfWgrl7nHPDcCOShIjVvU5SziTKHg49xR', NULL, '87.236.176.193', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777411766),
('ZtOxUqjZao8YsvIXceTAjVvguK7tBIrKFedQ7CD5', NULL, '185.247.137.65', 'Mozilla/5.0 (compatible; InternetMeasurement/1.0; +https://internet-measurement.com/)', '', 1777427914);
...
(15, 'app_logo', 'uploads/settings/aajrbtCdJAXY4krYD1IR2k4WSeDVhAyPWOzhNqiy.png', '2026-02-17 22:37:17', '2026-04-26 15:52:50'),
(16, 'app_favicon', 'uploads/settings/6cA8GIEPlEWujdCC6nRyPPnZkZzWmHrX9j5UG4TF.png', '2026-02-17 22:37:17', '2026-04-26 15:52:50');
...
(210, 7, 'user.login', 'App\\Models\\User', 7, NULL, '{\"email\":\"digital_marketing@example.com\"}', '{\"ip\":\"103.88.140.177\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-26 11:52:05'),
(211, 7, 'user.logout', 'App\\Models\\User', 7, NULL, '{\"email\":\"digital_marketing@example.com\"}', '{\"ip\":\"103.88.140.177\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-26 11:52:19'),
(212, 1, 'user.login', 'App\\Models\\User', 1, NULL, '{\"email\":\"hello@inoodex.com\"}', '{\"ip\":\"103.88.140.177\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-26 11:52:26'),
(213, 1, 'user.logout', 'App\\Models\\User', 1, NULL, '{\"email\":\"hello@inoodex.com\"}', '{\"ip\":\"103.88.140.177\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-26 11:52:57'),
(214, 6, 'user.login', 'App\\Models\\User', 6, NULL, '{\"email\":\"application@example.com\"}', '{\"ip\":\"103.88.140.179\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-27 12:26:29'),
(215, 1, 'user.login', 'App\\Models\\User', 1, NULL, '{\"email\":\"hello@inoodex.com\"}', '{\"ip\":\"103.88.141.59\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-28 04:29:27'),
(216, 1, 'user.logout', 'App\\Models\\User', 1, NULL, '{\"email\":\"hello@inoodex.com\"}', '{\"ip\":\"103.88.141.59\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-28 04:30:34'),
(217, 4, 'user.login', 'App\\Models\\User', 4, NULL, '{\"email\":\"accountant@example.com\"}', '{\"ip\":\"103.88.141.59\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-28 04:30:43'),
(218, 4, 'user.login', 'App\\Models\\User', 4, NULL, '{\"email\":\"accountant@example.com\"}', '{\"ip\":\"103.88.141.59\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-28 10:03:32'),
(219, 4, 'user.login', 'App\\Models\\User', 4, NULL, '{\"email\":\"accountant@example.com\"}', '{\"ip\":\"103.88.140.181\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-30 03:10:29'),
(220, 4, 'user.logout', 'App\\Models\\User', 4, NULL, '{\"email\":\"accountant@example.com\"}', '{\"ip\":\"103.88.140.181\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-30 03:11:20'),
(221, 4, 'user.login', 'App\\Models\\User', 4, NULL, '{\"email\":\"accountant@example.com\"}', '{\"ip\":\"103.88.140.180\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-30 03:19:44'),
(222, 4, 'user.login', 'App\\Models\\User', 4, NULL, '{\"email\":\"accountant@example.com\"}', '{\"ip\":\"103.88.140.181\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/147.0.0.0 Safari\\/537.36\",\"is_console\":false}', '2026-04-30 12:36:22');
